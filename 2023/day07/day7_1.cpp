...
int main() {
    ...
    struct comparator {
        unordered_map<char, int> mp = {{'A',13}, {'K',12}, {'Q',11}, {'J',10}, {'T',9}, {'9',8}, {'8',7}, {'7',6}, {'6',5}, {'5',4}, {'4',3}, {'3',2}, {'2',1}};
    ...
    while(getline(input_file, line)) {
        ...
        if (freq[0]==5) types[0].push_back(hand);
        else if (freq[0]==4) types[1].push_back(hand);
        else if (freq[0]==3&&freq[1]==2) types[2].push_back(hand);
        else if (freq[0]==3&&freq[1]==1) types[3].push_back(hand);
        else if (freq[0]==2&&freq[1]==2) types[4].push_back(hand);
        else if (freq[0]==2&&freq[1]==1) types[5].push_back(hand);
